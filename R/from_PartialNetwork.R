...
fcoefficients       <- getFromNamespace("fcoefficients", "PartialNetwork") 

formula.to.data     <- getFromNamespace("formula.to.data", "PartialNetwork") 

formula.to.data.smm <- getFromNamespace("formula.to.data.smm", "PartialNetwork") 
